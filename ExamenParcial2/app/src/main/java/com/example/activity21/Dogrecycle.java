...
public class Dogrecycle extends AppCompatActivity implements Handler.Callback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dogrecycle);
        rvFriendsList = findViewById(R.id.rvDogList);
